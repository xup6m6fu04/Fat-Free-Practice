...
$f3->route('POST /api/add-student-with-school-and-class', 'App\Controllers\StudentController->addStudentWithSchoolAndClass');
...
$f3->route('POST /api/test-student-repository', 'App\Repositories\StudentRepository->getStudentsInStudentId');